        ...
        <div class="container">
            <div class="left-section">
                <div class="inner-content">
                    <h1 class="heading">Dang...</h1>
                    <p class="subheading">Looks like an error ocurred. Please accept our apologies.</p>
                    <a class="backtohomepage" href="{{ url('/') }}">Back to homepage</a>
                </div>
            </div>
